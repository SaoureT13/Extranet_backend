...
//        var_dump($arrayJson);
        ...
        isset($_POST['SUBSTITUTION_PRODUCTS']) ? $SUBSTITUTION_PRODUCTS = $_POST['SUBSTITUTION_PRODUCTS'] : $SUBSTITUTION_PRODUCTS = null;
        $ConfigurationManager->uploadProductPicture($PICTURES, $SUBSTITUTION_PRODUCTS, $LG_PROID, $OUtilisateur);
    } //moi
        ...
        $ConfigurationManager->deleteProductImage($LG_DOCID);
    }
